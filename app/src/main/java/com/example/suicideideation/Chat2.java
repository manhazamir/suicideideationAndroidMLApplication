...
public class Chat2 extends AppCompatActivity {
    ...
    private String url = "http://192.168.43.192:5000/" ;
...
//                getQuestions();
                ...
                final SpeechRecognizer recognizer = SpeechRecognizer.createSpeechRecognizer(Chat2.this);
                RecognitionListener listener = new RecognitionListener() {
                    ...
                    public void onResults(Bundle results) {
                        ...
                        int score = 0;
                        if(questions.get(index2).contains("اپنا سیشن شروع کرتے")|| questions.get(index2).contains("Lets start our session")){
        ...
        chatBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Chat2.this, Home.class);
    ...
    public void speech(String msg){
        tts = new TextToSpeech(Chat2.this, new TextToSpeech.OnInitListener() {
            @Override
            public void onInit(int i) {
                if(i == TextToSpeech.SUCCESS){
                    ...
                    if (result == TextToSpeech.LANG_MISSING_DATA || result == TextToSpeech.LANG_NOT_SUPPORTED) {
                        ...
                        Toast.makeText(Chat2.this, "This Language is not supported", Toast.LENGTH_SHORT).show();
                        ...
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                            ...
                            Toast.makeText(Chat2.this, "Api level not enough", Toast.LENGTH_SHORT).show();
                        }
        ...
        HTTPrequest.callAPI("Post", url, params, header, new HTTPrequest.VolleyCallback() {
            ...
            public void onSuccess(String result) {
                try {
                    ...
                    Toast.makeText(Chat2.this, "", Toast.LENGTH_SHORT).show();
            ...
            public void onFaliure(String faliure) {
                Toast.makeText(Chat2.this, "Loser you failed!", Toast.LENGTH_SHORT).show();
                return;
            }
        },this);
